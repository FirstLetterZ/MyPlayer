...
import com.zpf.common.player.util.MeasureHelper;
...
public class SurfaceRenderView extends SurfaceView implements IRenderView {
    ...
    private static final class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        private SoftReference<SurfaceRenderView> mWeakSurfaceView;
        private Map<IRenderCallback, Object> mRenderCallbackMap = new ConcurrentHashMap<IRenderCallback, Object>();

        public SurfaceCallback(@NonNull SurfaceRenderView surfaceView) {
            mWeakSurfaceView = new SoftReference<SurfaceRenderView>(surfaceView);
        }
